...
public class Player : MonoBehaviour, IKitchenObjectParent
{
    ...
    private void Awake()
    {
        if (Instance != null) Debug.LogError("There is more thane one Player instance!");
        else Instance = this; 
    }
    ...
    private void SetSelecterCounter(ClearCounter _selectedCounter)
    {
